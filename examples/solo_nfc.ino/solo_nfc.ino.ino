...
int pinBTN_Del_P1 = 23;
int pinBTN_Add_P2 = 24;
int pinBTN_Del_P2 = 25;
int pinBTN_Add_P3 = 26;
int pinBTN_Del_P3 = 27;
...
void setup() { 
  ...
  pinMode(pinBTN_Del_P1,INPUT);
  pinMode(pinBTN_Add_P2,INPUT);
  pinMode(pinBTN_Del_P2,INPUT);
  pinMode(pinBTN_Add_P3,INPUT);
  pinMode(pinBTN_Del_P3,INPUT);
...
void loop() {
  ...
  int estBtnDelP1 = digitalRead(pinBTN_Del_P1);
  int estBtnAddP2 = digitalRead(pinBTN_Add_P2);
  int estBtnDelP2 = digitalRead(pinBTN_Del_P2);
  int estBtnAddP3 = digitalRead(pinBTN_Add_P3);
  int estBtnDelP3 = digitalRead(pinBTN_Del_P3);
  ...
  if(estBtnAddP1 == HIGH){
    if(orderSizeVal()){
      ...
      Serial.println("Orden llena");
    }
    delay(300);
  }

  if (estBtnDelP1 == HIGH){
    Serial.println("Cocan't");
    for(int i = 0;i<ORDER.Count();i++){
      if(ORDER[i] == "Coca"){
        ORDER.Remove(i);
        cost-=5;
      } else {
        Serial.println("No existente");
      }
    }
    delay(300);
  }
